          ...
          <div id="shop-page" style={{ padding: "64px 24px" }} className="fade-in">
            <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
              <div className="section-header">
                ...
                <h2 className="section-title">Exclusive Maple Leafs Memorabilia</h2>
              </div>
              ...
              <div className="events-grid">
                {[
                  { name: "Maple Leafs Autographed Home Jersey", price: 1250, img: "https://images.unsplash.com/photo-1515523110800-9415d13b84a8?w=600&h=400&fit=crop" },
                  { name: "Maple Leafs Signed Game Stick", price: 850, img: "https://images.unsplash.com/photo-1580748141549-71748dbe0bdc?w=600&h=400&fit=crop" },
                  { name: "Official Maple Leafs Game Puck (Signed)", price: 299, img: "https://images.unsplash.com/photo-1549646320-c255d49133bd?w=600&h=400&fit=crop" },
                  { name: "Maple Leafs Limited Edition Framed Photo", price: 450, img: "https://images.unsplash.com/photo-1505367332454-e4c19ea5518b?w=600&h=400&fit=crop" },
                ].map((item, i) => (
