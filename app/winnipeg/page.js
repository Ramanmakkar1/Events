...
export default function Home() {
  ...
  const fetchEvents = useCallback(async (dateToFetch) => {
    ...
    try {
      ...
      const url = `https://app.ticketmaster.com/discovery/v2/events.json?apikey=${API_KEY}&city=Winnipeg&stateCode=MB&countryCode=CA&startDateTime=${s}&endDateTime=${e}&size=199&sort=date,asc`;
  ...
  const homeStats = useMemo(() => {
    ...
    const oilers = allEvents.filter(
      (ev) => ev.category === "Sports" && ev.name.toLowerCase().includes("jets")
    ).length;
  ...
  const homeOilersEvents = useMemo(() => {
    return allEvents
      .filter((ev) => ev.category === "Sports" && ev.name.toLowerCase().includes("jets"))
      .slice(0, 8);
  }, [allEvents]);
            ...
            <section className="stats-section">
              <div className="stats-grid">
                ...
                <div className="stat-card fade-up" style={{ animationDelay: "0.2s" }}>
                  ...
                  <div className="stat-label">Jets games</div>
                </div>
              ...
              <section className="content-section">
                <div className="content-inner">
                  <div className="section-header">
                    ...
                    <h2 className="section-title">This Week in Winnipeg</h2>
                  </div>
                  ...
                  <div className="oilers-header">
                    ...
                    <div>
                      <h2 style={{ fontSize: "28px", fontWeight: 900, letterSpacing: "-1px" }}>
                        Winnipeg <span style={{ color: "var(--accent)" }}>Jets</span>
                      </h2>
                      <p style={{ color: "var(--text2)", fontSize: "14px" }}>
                        Upcoming games at Canada Life Centre
                      </p>
                    </div>
                  </div>
                  <div className="events-grid">
            ...
            <section className="cta-section">
              <div className="cta-box">
                ...
                <p>
                  ...
                  from Ticketmaster so you always know what's happening in Winnipeg.
                </p>
                <button
                  className="btn-primary"
                  onClick={() => setActivePage("events")}
          ...
          <div id="shop-page" style={{ padding: "64px 24px" }} className="fade-in">
            <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
              <div className="section-header">
                ...
                <h2 className="section-title">Exclusive Jets Memorabilia</h2>
              </div>
              ...
              <div className="events-grid">
                {[
                  { name: "Jets Autographed Home Jersey", price: 1250, img: "https://images.unsplash.com/photo-1515523110800-9415d13b84a8?w=600&h=400&fit=crop" },
                  { name: "Jets Signed Game Stick", price: 850, img: "https://images.unsplash.com/photo-1580748141549-71748dbe0bdc?w=600&h=400&fit=crop" },
                  { name: "Official Jets Game Puck (Signed)", price: 299, img: "https://images.unsplash.com/photo-1549646320-c255d49133bd?w=600&h=400&fit=crop" },
                  { name: "Jets Limited Edition Framed Photo", price: 450, img: "https://images.unsplash.com/photo-1505367332454-e4c19ea5518b?w=600&h=400&fit=crop" },
                ].map((item, i) => (
        ...
        <footer>
          <div className="footer-inner">
            ...
            <p className="footer-desc">
              Built for Winnipeg locals who want
              to know what's happening in their city.
            </p>
            <div className="footer-socials">
              <span className="footer-social">@winnipegweekend</span>
              <span className="footer-social">@winnipegweekend</span>
              <span className="footer-social">@winnipegweekend</span>
            </div>
